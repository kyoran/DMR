...
def main():
    ...
    for step in range(1000):
        ...
        if args.encoder_type == "pixelConNewV4":
        ...
        saved_dir = f"{args.domain_name}_{args.selected_weather}"
        ...
        plt.savefig(f"./conv/{step}-rgb.jpg", bbox_inches=rgb_extent)
        plt.savefig(f"./conv/{step}-dvs.jpg", bbox_inches=dvs_extent)
        plt.savefig(f"./conv/{step}-rgb-mask.jpg", bbox_inches=rgb_mask_extent)
        plt.savefig(f"./conv/{step}-dvs-mask.jpg", bbox_inches=dvs_mask_extent)
        plt.savefig(f"./conv/{step}-com-mask.jpg", bbox_inches=com_mask_extent)
        plt.savefig(f"./conv/{step}-rgb-mask-sup.jpg", bbox_inches=rgb_mask_sup_extent)
        plt.savefig(f"./conv/{step}-dvs-mask-sup.jpg", bbox_inches=dvs_mask_sup_extent)
        plt.savefig(f"./conv/{step}-com-mask-rgb-sup.jpg", bbox_inches=com_mask_rgb_sup_extent)
        plt.savefig(f"./conv/{step}-com-mask-dvs-sup.jpg", bbox_inches=com_mask_dvs_sup_extent)
