...
def evaluate(args, image_dir, eval_env, agent, video, num_eval_episodes, L, step,
             one_weather, device=None, embed_viz_dir=None, do_carla_metrics=None):
    ...
    for i in range(num_eval_episodes):
        ...
        while not done:
            ...
            if True and embed_viz_dir and step >= 80000:
                ...
                with torch.no_grad():
                    ...
                    con_h, [rgb_h, con_h_rgb, dvs_h, con_h_dvs], con_conv, [rgb_conv, dvs_conv] \
